                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text" >
                            <h1 style="color:#000">Create An Event! Let people know of you..</h1>
                        ...
                        <div class="col-sm-8 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h2>Fill up your event details</h2>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="<?php echo base_url(); ?>index.php/Events/event_validate" method="post" id="makeEvent" class="registration-form" enctype="multipart/form-data">
									...
									<div class="form-group">
			                        	...
			                        	<input type="text" name="form-name" placeholder="Enter Name of event..." value="<?php echo set_value('form-name'); ?>" class="form-title form-control" id="form-title">
			                        </div><br>

			                        <div class="form-group">
			                        	<h5>Company Name <span style="color:red;">*</span></h5> (Company conduncting the event.)
			                        	<input type="text" name="form-companyname" placeholder="Name of comapny conducting the event" value="<?php echo set_value('form-tagline'); ?>" class="form-title form-control" id="form-title">
			                        </div><br>

			                        <div class="form-group">
			                        	<h5>Tagline <span style="color:red;">*</span></h5> (Or a one line description, max 50 characters.)
			                        	<input type="text" name="form-tagline" placeholder="Enter one line description of your event..." value="<?php echo set_value('form-tagline'); ?>" class="form-title form-control" id="form-title">
			                        </div><br>
									...
									<div class="form-group">
			                        	...
			                        	<textarea name="form-description" class="form-text form-control" id="form-text_h1" rows="5" placeholder="WHat your event is all about!"></textarea>
			                        </div><br>
			                        ...
			                        <div class="form-group">
			                        	...
			                        	<textarea name="form-contactus" class="form-text form-control" placeholder="Enter All people would need to reach you.." id="form-text_h3" rows="5"></textarea>
			                        </div><br>
			                        ...
			                        <div class="form-group">
			                        	...
			                        	<div class="row">
			                        		<div class="col-md-3">
			                        			<input name="form-numdays" type="number" class="form-title form-control" id="numDays">
			                        		</div>
			                        		<div class="col-md-2">
			                        ...
			                        <div id="numDays1">
			                        	<div class="form-group">
				                        	...
				                        	<input type="text" name="form-numday1" class="datepicker" id="dp1" />
				                        </div><br>
			                        </div>
			                        ...
			                        <div id="numDays2">
			                        	<div class="form-group">
				                        	...
				                        	<input type="text" name="form-numday2" class="datepicker" id="dpfrom" />
				                        </div>
				                        <div class="form-group">
				                        	<h6>Events Ends on<span style="color:red;">*</span></h6>
				                        	<input type="text" name="form-numday3" class="datepicker" id="dpto" />
				                        </div><br>
			                        </div>
...
console.log(flag);
        			if(flag== 0)
        			{
	        			...
	        			$.ajax({
	        				...
	        				type:"POST",
	        				data:signupdata,
	        				url:"<?php echo base_url(); ?>/index.php/Events/event_validate",
	        				success:function(msg){
								...
								if(msg.status == 'true')
	        					{
	        						alert('your event has been generated!.');
	        						window.location.href = "<?php echo base_url(); ?>index.php/Events/page_done";
	        					}else
	        					{
